...
SyndromicMgmt is now in core stisim — use sti.SyndromicMgmt directly.
"""
...
SyndromicMgmt = sti.SyndromicMgmt  # re-export for any local code that imports it by name
